...
import ru.kazakov.library.exceptions.AlreadyExistsException;
import ru.kazakov.library.exceptions.NotFoundException;
import ru.kazakov.library.service.BookService;
...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public Book addBook(String title, String author, int quantity) throws AlreadyExistsException {
    ...
    @Override
    public Book editBook(UUID id, String title, String author, int quantity) {
        if (!bookRepository.existsById(id)) {
            throw new NotFoundException("Book not found");
        }
